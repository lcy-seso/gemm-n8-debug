if(CMAKE_CUDA_COMPILER_LOADED OR DEFINED CMAKE_CUDA_COMPILER_ID) # CUDA as a
                                                                 # language
...
# See: https://docs.nvidia.com/cuda/cuda-compiler-driver-nvcc/index.html#gpu-
# feature-list
...
function(CUDA_DETECT_INSTALLED_GPUS OUT_VARIABLE)
  if(NOT CUDA_GPU_DETECT_OUTPUT)
    ...
    string(REGEX MATCHALL "[0-9]+\\.[0-9]+" compute_capabilities
  ...
  if(NOT CUDA_GPU_DETECT_OUTPUT)
    ...
    foreach(ITEM IN ITEMS ${CUDA_GPU_DETECT_OUTPUT})
      if(CUDA_LIMIT_GPU_ARCHITECTURE
         AND (ITEM VERSION_GREATER CUDA_LIMIT_GPU_ARCHITECTURE
              OR ITEM VERSION_EQUAL CUDA_LIMIT_GPU_ARCHITECTURE))
...
# ##############################################################################
# Function for selecting GPU arch flags for nvcc based on CUDA architectures
# from parameter list Usage: SELECT_NVCC_ARCH_FLAGS(out_variable [list of CUDA
# compute archs])
  ...
  foreach(arch_name ${CUDA_ARCH_LIST})
    ...
    if(arch_name MATCHES "^([0-9]\\.[0-9](\\([0-9]\\.[0-9]\\))?)$")
      ...
      elseif(${arch_name} STREQUAL "Ampere")
        ...
        message(
          SEND_ERROR
            "Unknown CUDA Architecture Name ${arch_name} in CUDA_SELECT_NVCC_ARCH_FLAGS"
        )
      endif()
    endif()
    if(NOT arch_bin)
