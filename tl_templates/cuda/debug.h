...
template <>
__device__ void debug_print_var<half>(const char* msg, half var) {
    printf(
...
// Specialization for signed char type
template <>
__device__ void debug_print_buffer_value<signed char>(const char* msg,
                                                      const char* buf_name,
                                                      int index,
                                                      signed char var) {
    printf(
...
// Specialization for bfloat16_t type
template <>
__device__ void debug_print_buffer_value<bfloat16_t>(const char* msg,
                                                     const char* buf_name,
                                                     int index,
                                                     bfloat16_t var) {
    printf(
